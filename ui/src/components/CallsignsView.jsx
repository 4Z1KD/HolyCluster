...
function CallsignsView({
    ...
    const toggled_classes = toggled_ui.right ? "hidden " : "max-2xl:absolute z-50 right-20 top-0 border-l border-slate-300 ";
    return <div className={toggled_classes + " 2xl:flex flex-col bg-white h-full divide-y divide-slate-300 w-60"}>
