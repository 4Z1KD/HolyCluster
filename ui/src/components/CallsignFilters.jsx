...
function CallsignFilters({ filters, set_filters, is_show_only }) {
    ...
    return <CallsignsList
        callsigns={callsigns}
        set_callsigns={is_show_only ? callsigns => set_filters(state => state.include_callsigns = callsigns) : callsigns => set_filters(state => state.exclude_callsigns = callsigns)}
