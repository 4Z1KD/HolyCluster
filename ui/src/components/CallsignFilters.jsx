        ...
        title={
            <div className="flex w-full items-center p-1">
                ...
                <div className="ml-auto">{
                    is_show_only ?
                    <Toggle value={filters.is_include_filters_active} on_click={() => {
                        set_filters(state => state.is_include_filters_active = !state.is_include_filters_active);
                    }}/>
                    :
                    <Toggle value={filters.is_exclude_filters_active} on_click={() => {
                        set_filters(state => state.is_exclude_filters_active = !state.is_exclude_filters_active);
                    }}/>
                }</div>
            </div>
        }
